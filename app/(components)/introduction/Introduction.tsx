...
export default function Introduction() {
  return (
    <Wrapper title="QUIENES SOMOS" id="quienes-somos">
      <div className="md:flex-row flex-col flex gap-12 items-center justify-between">
        <div className="flex gap-8 flex-col max-w-[650px]">
          ...
          <p className="text-xl">
            Nuestro objetivo es promover la música tanto en el ámbito educativo,
            como terapéutico y ¿porque no? también en el lúdico, divulgando así
            la cultura musical además de mejorar la calidad de vida de un amplio
            sector de la sociedad. Nuestra cobertura va desde el bebé en el
            útero hasta la tercera edad, pasando por todas las etapas de vida
            intermedias.
          </p>
        </div>
        <Card customClass="flex flex-col gap-6 items-center text-center max-w-[450px]">
          ...
          <p className="text-white text-sm">
            ...
            Psicológicos cursando el Master en Musicoterapia. Músico profesional
            por el Conservatorio Musical “Maestro Mário Veneri” de Monte Alto,
            instrumento piano
          </p>
        </Card>
      </div>
